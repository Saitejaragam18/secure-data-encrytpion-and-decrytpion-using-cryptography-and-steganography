...
def owner_split():
   ...
   #   DES PART
    ...
    fileDES= open("C:/Users/saite/OneDrive/Desktop/input/DES.txt", "w")
    fileDES.write(str(desencrypted.encode("utf-8")))
    fileDES.close()
    #uploadFile('DES.txt',"C:/Users/DELL/OneDrive/Desktop/input/DES.txt")
    ...
    fileAES= open("C:/Users/saite/OneDrive/Desktop/input/AES.txt", "w")
    fileAES.write(str(aesencrypted))
    fileAES.close()
    #uploadFile('AES.txt',"C:/Users/DELL/OneDrive/Desktop/input/AES.txt")
    ...
    print (txt)
    print(ciphertext)
    fileRSA= open("C:/Users/saite/OneDrive/Desktop/input/RSA.txt", "w")
    fileRSA.write(txt)
    fileRSA.close()
    #uploadFile('RSA.txt',"C:/Users/DELL/OneDrive/Desktop/input/RSA.txt")
...
def owner_response():
       ...
       if status == True:
          for skey,skey1,skey2,f1,f2,f3 in rdata:
               ...
               filen= open("C:/Users/saite/OneDrive/Desktop/input/jointkey.txt", "w")
               filen.close()
               filen=open("C:/Users/saite/OneDrive/Desktop/input/jointkey.txt",'a') #text file where all 3 keys are stored
               filen.write(skey)
               filen.write(skey1)
               filen.write(skey2)
               filen.close
               stringkeys = 'fi'+skey+'se'+skey1+'co'+skey2+'th'
          with open("C:/Users/saite/OneDrive/Desktop/input/jointkey.txt",'r')as f:
               #stringkeys = f.readlines()
               print("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
               print(stringkeys)
               msg= lsb.hide("C:/Users/saite/OneDrive/Desktop/input/bt.png",str(stringkeys)) #hide key in image
               msg.save("C:/Users/saite/OneDrive/Desktop/input/bt_sec.png") #save the embedded image
       ...
       for filename,owner in dats:
           ...
           if fdata:
            for skey,skey1,skey2,f1,f2,f3 in fdata:
             clear_msg = lsb.reveal("C:/Users/saite/OneDrive/Desktop/input/bt_sec.png") # take out keys from image
           ...
           file1 = open("C:/Users/saite/OneDrive/Desktop/input/myfile.txt","w") 
